...
from core.views import view_home, view_home_tag_retirada_sp, view_home_tag_coleta_sp, view_home_tag_transporte_sp, view_home_tag_zona_sul, view_home_tag_retiradas_sp, view_home_tag_retirada_interlagos, view_home_v3
